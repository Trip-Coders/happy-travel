...
@section('content')
<div class="container">
    <h4 class="text-danger">Crear Destino</h4>
    ...
    <form method="POST" action="{{ route('destinations.create') }}" enctype="multipart/form-data" class="form-container">
        ...
        <div>
            <div class="mb-3">
                ...
                <input type="text" id="title" name="title" class="form-control rounded-pill title-shadow" placeholder="Escribe el nombre del lugar" required>
            </div>
            <div class="mb-3">
                <label for="location" class="form-label text-primary">Ubicación</label>
                <input type="text" id="location" name="location" class="form-control rounded-pill location-shadow" placeholder="Escribe la ubicación" required>
            </div>
            <div class="mb-3">
            ...
            <div>
                ...
                <a href="{{ route('home') }}" class="btn rounded-pill" id="btn-cancel">Cancelar</a>
            </div>
        </div>
        <div class="mb-3">
            <label for="content me-3" class="form-label text-primary">¿Por qué quieres viajar allí?</label>
            <textarea name="content" class="form-control rounded-box content-shadow ms-4" rows="10" placeholder="Escribe tus razones aquí" required></textarea>
        </div>
    </form>
</div>
@endsection
